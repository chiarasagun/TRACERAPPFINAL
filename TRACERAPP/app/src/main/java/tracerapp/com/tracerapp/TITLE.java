...
public class TITLE extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button my = (Button) findViewById(R.id.button);
        my.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TITLE.this, SECONDFLOOR.class));
            }
        });
        ...
        my1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TITLE.this, THIRDFLOOR.class));
            }
        });
        ...
        my2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TITLE.this, FOURTHFLOOR.class));
            }
        });
        ...
        my3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TITLE.this, FIFTHFLOOR.class));
            }
        });

        Button my4 = (Button) findViewById(R.id.button5);
        my4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TITLE.this, RESERVEFORM.class));
            }
        });

        Button my5 = (Button) findViewById(R.id.button6);
        my5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TITLE.this, MAIN.class));
            }
        });
